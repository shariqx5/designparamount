				...
				<div className="row">
					<div className="col-lg-6 col-md-7">
						<div className="fixed-scroll-area">
							<div className={this.props.showBlack?"section-heading":"section-heading"}>
							...
							<div className={this.props.showBlack?"fixed-scroll-area-link":"fixed-scroll-area-link"}>
								<ul> 
					...
					<div className={this.props.showBlack?"col-lg-6 col-md-5":"col-lg-6 col-md-5"}>
