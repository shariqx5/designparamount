                    ...
                    <div className="row">
                        <div className="col-md-5 pt-25">
                            <div className="banner-heading standardbannerheadingdiv">
                                <h6 style={{position:"relative"}}><img src="images/standard/circle.png" alt="" className="position-absolute" style={{left:"-5px",zIndex:"2",maxWidth:"60px",top:"-18px"}}/>Web Design</h6>
                        ...
                        <div className="col-md-7 standardpagemainbannerimg">
                            <ImageOptimizer path={"design_gigantic/banners/web_banner.png"} lqip={{active:true, quality:20}}/>
                        </div>
                    </div>
                </div>
        </section>
