...
import style from './privacyJumbotron.module.css';

class PrivacyJumbotron extends Component{

    render(){
        return(
            <section className={`home-banner position-rel ${style.home_banner}`} id="counter" style={{height:"auto",minHeight:"410px"}}>
            <img src="/images/aboutus/3.png" alt="" className="position-absolute" style={{width:"100%",let:"-22px",zIndex:"2",maxWidth:"75px",transform:"rotate(-180deg)",top:"70px"}} />
