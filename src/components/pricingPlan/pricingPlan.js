...
import style from '../../pages/pricing/pricing.module.css';
...
class PricingPlan extends Component{
    ...
    render(){
        return(
            <section className={`${style.pricingplaninfosec} position-rel`} style={{...this.props}}>
	        ...
	        <div className="container">
	            ...
	            <div className={`row ${style.pricingplanrow}`}>
	                <div className="col-md-4">
	                   <div className={`${style.single_service}`}>
							<div className={`${style.single_service_img}`}>
								<img src="/images/pricing/icon1.png" alt="" />
							</div>
							<div className={`${style.single_service_detail}`}>
