...
const Heading = ()=>{
    return(
        <div className="section-heading">
            <h1>Brand Design <span>In Detail</span></h1>
...
const SideImage = ()=>{
    return(
        <ImageOptimizer path={"/design_gigantic/side-sections/branding-side-section.png"} lqip={{active:true, quality:20}} className="logo-side-sec"/>
    )
};
