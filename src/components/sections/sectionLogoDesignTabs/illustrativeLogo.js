...
class IllustrativeLogo extends Component{

    render(){
        return(<div role="tabpanel" className="tab-pane fade" id="illustrative-logo-service">
	        <div className="row">
                ...
                <div className="col-md-6 d-flex align-items-center justify-content-center">
					<ImageOptimizer path={"/design_gigantic/logo-types/pictorial_logo.jpg"} lqip={{active:true, quality:20}}/>
                </div>
            </div>
	    </div>)
    }
...
export default IllustrativeLogo;