...
class EmblemLogo extends Component{

    render(){
        return(<div role="tabpanel" className="tab-pane fade" id="emblem-logo-service">
	        <div className="row">
	            <div className="col-md-6">
	                <div className="section-heading">
						<h1>Portal <span>Website</span></h1>
                ...
                <div className="col-md-6 d-flex align-items-center justify-content-center">
					<ImageOptimizer path={"/design_gigantic/web-type/4.png"} lqip={{active:true, quality:20}}/>
                </div>
            </div>
	    </div>)
    }
