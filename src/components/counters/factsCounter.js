    ...
    render(){
        return(
            <section className="bgpurplecolor corevaluesec aboutfactsec position-rel">
                <img src="images/aboutus/5.png" alt="" className="position-absolute" style="width: 100%;left: 190px;z-index: 2;max-width: 85px;top: 165px;" />
                <img src="images/aboutus/6.png" alt="" className="position-absolute" style="width: 100%;right: 236px;bottom: 35px;z-index: 2;max-width: 110px;" />
                <img src="images/aboutus/4.png" alt="" className="position-absolute" style="width: 100%;left: -25px;bottom: 35px;z-index: 2;max-width: 75px;" />
                <img src="images/aboutus/3.png" alt="" className="position-absolute" style="width: 100%;top: 65px;right: -46px;z-index: 2;max-width: 100px;" />
