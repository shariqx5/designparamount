						...
						<div className="row height-full">
							...
							<div className="col-md-5">
								<div className="testimonial-bubble-area">
									...
									<div className="testimonial-bubble">
										<div className="testimonial-bubble-img">
											<img src="images/testimonials/bubbles/2.jpg" alt="" />
										</div>
										<div className="textimonial-bubble-detail">
			...
			<div className="container">
				<div className="row">
					<div className="col-lg-5 col-md-5 offset-md-7">
						...
						<a href="case-study-list.html" className="thick-link">Explore More Case Studies <i className="fas fa-long-arrow-alt-right"></i></a>
					</div>
				</div>
			</div>
		</section>
