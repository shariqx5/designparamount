    ...
    render(){
        return(
            <Layout>
                ...
                <section classNameName="purple-sec portfolio-before-sec mt-40" id="portfolio">
                    <img src="/images/shapes/triangle.png" alt="" classNameName="position-absolute top-0 left-0 triangle-top-left max-width-190" />
                    <img src="/images/shapes/circle.png" alt="" classNameName="position-absolute top-0 right-0 circle-top-right max-width-190" />
